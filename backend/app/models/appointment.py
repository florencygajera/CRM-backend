"""Appointment model and status enums."""
...
class Appointment(Base):
    ...
    __table_args__ = (
        ...
        Index(
            "ix_appt_tenant_branch_staff_start",
            "tenant_id", "branch_id", "staff_user_id", "start_at",
        ),
    )
    ...
    status: Mapped[str] = mapped_column(
        String(20), default=AppointmentStatus.PENDING, nullable=False,
    )
    ...
    payment_status: Mapped[str] = mapped_column(
        String(20), default=ApptPayStatus.UNPAID, nullable=False,
    )
